        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-white dark:bg-gray-800 shadow-lg fixed h-full">
                ...
                <nav class="p-4 space-y-1 overflow-y-auto" style="max-height: calc(100vh - 120px);">
                    ...
                    <a href="{{ route('financial-projections.index') }}" class="flex items-center px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('financial-projections.*') ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
