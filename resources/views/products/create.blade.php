        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="cost_price" name="cost_price" value="{{ old('cost_price') }}" step="0.01" min="0"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <input type="text" id="unit_of_measure" name="unit_of_measure" value="{{ old('unit_of_measure', 'Unidad') }}" required
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <select id="valuation_method" name="valuation_method" required
                        ...
                        <option value="lifo" {{ old('valuation_method') === 'lifo' ? 'selected' : '' }}>LIFO</option>
                        <option value="average" {{ old('valuation_method') === 'average' ? 'selected' : '' }}>Promedio</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" step="0.001" min="0"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <input type="number" id="min_stock" name="min_stock" value="{{ old('min_stock') }}" step="0.001" min="0"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <input type="number" id="max_stock" name="max_stock" value="{{ old('max_stock') }}" step="0.001" min="0"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">{{ old('description') }}</textarea>
