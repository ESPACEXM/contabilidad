...
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Editar Empresa</h1>
        ...
        <form action="{{ route('tenants.update', $tenant) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="razon_social" name="razon_social" value="{{ old('razon_social', $tenant->razon_social) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <input type="text" id="rfc" name="rfc" value="{{ old('rfc', $tenant->rfc) }}" maxlength="20"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                ...
                <div>
                    ...
                    <select id="currency" name="currency" required
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        <option value="MXN" {{ old('currency', $tenant->currency) === 'MXN' ? 'selected' : '' }}>MXN - Peso Mexicano</option>
                        <option value="USD" {{ old('currency', $tenant->currency) === 'USD' ? 'selected' : '' }}>USD - Dólar Estadounidense</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white">{{ old('address', $tenant->address) }}</textarea>
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Empresa activa</span>
                    </label>
                </div>
            </div>
