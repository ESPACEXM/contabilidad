...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="<?php echo e(route('products.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg">
            Nuevo Producto
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
        <form method="GET" action="<?php echo e(route('products.index')); ?>" class="flex gap-4 flex-wrap">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar por nombre o SKU..." 
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-lg">Limpiar</a>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <?php if($product->track_inventory): ?>
                                <span class="<?php echo e($product->hasLowStock() ? 'text-red-600 font-semibold' : 'text-gray-900 dark:text-white'); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('products.show', $product)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400">Ver</a>
                            <a href="<?php echo e(route('products.edit', $product)); ?>" class="ml-4 text-indigo-600 hover:text-indigo-900 dark:text-indigo-400">Editar</a>
                            <?php if($product->track_inventory): ?>
                                <a href="<?php echo e(route('inventory.kardex', $product)); ?>" class="ml-4 text-green-600 hover:text-green-900 dark:text-green-400">Kardex</a>
                            <?php endif; ?>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Proyecto Contabilidad\resources\views/products/index.blade.php ENDPATH**/ ?>