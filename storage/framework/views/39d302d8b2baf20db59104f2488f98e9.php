    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('register')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-500">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Proyecto Contabilidad\resources\views/auth/login.blade.php ENDPATH**/ ?>