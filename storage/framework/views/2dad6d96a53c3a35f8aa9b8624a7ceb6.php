...
<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($kpis['total_accounts']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($kpis['posted_entries']); ?>/<?php echo e($kpis['journal_entries']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($kpis['total_products']); ?></p>
                    <?php if($kpis['low_stock_products'] > 0): ?>
                        <p class="text-xs text-red-600 mt-1"><?php echo e($kpis['low_stock_products']); ?> con stock bajo</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($kpis['active_budgets']); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if(isset($balanceSheet) && isset($incomeStatement)): ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white">$<?php echo e(number_format($balanceSheet['total_assets'] ?? 0, 2)); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600 dark:text-gray-400">Total Pasivos</span>
                    <span class="font-semibold text-gray-900 dark:text-white">$<?php echo e(number_format($balanceSheet['total_liabilities'] ?? 0, 2)); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600 dark:text-gray-400">Capital</span>
                    <span class="font-semibold text-gray-900 dark:text-white">$<?php echo e(number_format($balanceSheet['total_equity'] ?? 0, 2)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-green-600">$<?php echo e(number_format($incomeStatement['total_revenues'] ?? 0, 2)); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600 dark:text-gray-400">Total Egresos</span>
                    <span class="font-semibold text-red-600">$<?php echo e(number_format($incomeStatement['total_expenses'] ?? 0, 2)); ?></span>
                </div>
                <div class="flex justify-between border-t pt-2">
                    <span class="text-gray-900 dark:text-white font-bold">Utilidad Neta</span>
                    <span class="font-bold <?php echo e(($incomeStatement['net_income'] ?? 0) >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        $<?php echo e(number_format($incomeStatement['net_income'] ?? 0, 2)); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($entry->entry_number); ?></p>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($entry->entry_date->format('d/m/Y')); ?></p>
                    </div>
                    <span class="px-2 py-1 text-xs rounded <?php echo e($entry->status === 'posted' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                        <?php echo e($entry->status === 'posted' ? 'Contabilizada' : 'Borrador'); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($movement->product->name); ?></p>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($movement->movement_date->format('d/m/Y')); ?> - <?php echo e(ucfirst($movement->type)); ?></p>
                    </div>
                    <span class="text-sm text-gray-900 dark:text-white"><?php echo e(number_format($movement->quantity, 2)); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="<?php echo e(route('journal-entries.create')); ?>" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
            ...
            <a href="<?php echo e(route('products.create')); ?>" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
            ...
            <a href="<?php echo e(route('financial-statements.balance-sheet')); ?>" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
            ...
            <a href="<?php echo e(route('budgets.create')); ?>" class="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
